...
<template>
    <Head title="Nulstil adgangskode – Aura" />
            ...
            <div class="auth-left-inner" :class="{ 'anim-ready': mounted }">
                ...
                <div class="auth-hero">
                    <h1 class="auth-hero-title">
                        Ny start —<br>
                        <span class="auth-hero-accent">vælg din nye adgangskode.</span>
                    </h1>
                    <p class="auth-hero-sub">
                        Opret en stærk adgangskode for at beskytte din konto. Vi anbefaler mindst 8 tegn med både bogstaver og tal.
                    </p>
                </div>
                <div class="auth-features">
                    <div class="auth-feature">
                        ...
                        <div>
                            <p class="auth-feature-title">Krypteret & sikker</p>
                            <p class="auth-feature-desc">Din adgangskode gemmes sikkert</p>
                        </div>
                    </div>
                    <div class="auth-feature">
                        <div class="auth-feature-icon">
                        ...
                        <div>
                            <p class="auth-feature-title">Engangsbrug</p>
                            <p class="auth-feature-desc">Linket udløber efter brug</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="auth-right">
            <div class="auth-form-wrap" :class="{ 'anim-ready': mounted }">
                <div class="auth-form-header">
                    <h2 class="auth-form-title">Nulstil adgangskode</h2>
                    <p class="auth-form-sub">Vælg en ny stærk adgangskode til din konto</p>
                </div>
                ...
                <form @submit.prevent="submit" class="auth-form">
                    ...
                    <div class="auth-field">
                        ...
                        <div class="auth-input-wrap">
                            ...
                            <input id="email" type="email" v-model="form.email" class="auth-input" :class="{ 'auth-input-error': form.errors.email }" required autocomplete="username" />
                        </div>
                    ...
                    <!-- New Password -->
                    <div class="auth-field">
                        <label for="password" class="auth-label">Ny adgangskode</label>
                        <div class="auth-input-wrap">
                            <span class="auth-input-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 1a4.5 4.5 0 0 0-4.5 4.5V9H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-.5V5.5A4.5 4.5 0 0 0 10 1Zm3 8V5.5a3 3 0 1 0-6 0V9h6Z" clip-rule="evenodd" /></svg>
                            </span>
                            <input id="password" :type="showPassword ? 'text' : 'password'" v-model="form.password" class="auth-input" :class="{ 'auth-input-error': form.errors.password }" placeholder="••••••••" required autofocus autocomplete="new-password" />
                    ...
                    <button type="submit" class="auth-submit" :disabled="form.processing">
                        <span v-if="!form.processing">Gem ny adgangskode</span>
                        <span v-else class="auth-spinner-wrap"><span class="auth-spinner"></span>Gemmer…</span>
                    </button>
                </form>
            </div>
        </div>
